...
- **Purpose:** Anonymous professional profile view with visible public fields, a vertical time-axis schedule with days as columns and public busy-slot cells, and a client booking request entry point.
