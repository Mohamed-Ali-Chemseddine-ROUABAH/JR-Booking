...
- **Purpose:** Lets an owner choose immediate, daily-digest, or no email for new messages, booking changes, and appointment reminders.
- **Imports:** Firestore document APIs, `core/firebase-init.js`, and `core/strings-fr.js`.
- **DOM owner:** Creates and owns the notification-preferences modal opened from the professional settings menu.
...
- **Feature flag:** Professional notification settings.
