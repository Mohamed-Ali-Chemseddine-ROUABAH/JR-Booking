...
- **Next implementation slice / Prochaine tranche:** the client application still awaits email verification; use the deployed admin resend action and complete verification plus approval/provisioning. Then continue real Google OAuth consent and sandbox calendar event import.
