...
function getBookingName(booking) { return booking.clientDisplayName || booking.guestName || booking.guestContact?.name || booking.clientEmail || strings.bookingFallback; }
